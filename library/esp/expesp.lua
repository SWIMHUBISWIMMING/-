...
local the_experemental_option_image = false
local the_experemental_option_displayname = false
if getgenv().exp_swimhub["image"] == true then the_experemental_option_image = true end
if getgenv().exp_swimhub["displayname"] == true then the_experemental_option_displayname = true end
-- services
...
function EspObject:Render()
	...
	visible.image.Visible = enabled and onScreen and options.imageesp;
	if visible.image.Visible then
		local box = visible.image;
		box.Position = corners.topLeft;
		box.Size = corners.bottomRight - corners.topLeft;
	end

    visible.displayname.Visible = enabled and onScreen and options.displayname;
	if visible.displayname.Visible then
		local name = visible.displayname;
...
local EspInterface = {
	...
	teamSettings = {    
		enemy = {
			enabled = false,
			imageesp = the_experemental_option_image,
			displayname = the_experemental_option_displayname,
			box = false,
